...
export class InvitationControllerService extends BaseService {
   ...
   */
  static readonly RejectInvitationPath = '/api/public/v1/invitations/{secret}/reject';
   ...
   */
  rejectInvitation$Response(params: {
    secret: string;
    ...
    const rb = new RequestBuilder(this.rootUrl, InvitationControllerService.RejectInvitationPath, 'put');
    if (params) {
  ...
  rejectInvitation(params: {
    ...
    return this.rejectInvitation$Response(params).pipe(
   ...
   */
  static readonly AcceptInvitationPath = '/api/public/v1/invitations/{secret}/accept';
   ...
   * This method doesn't expect any request body.
   */
  acceptInvitation$Response(params: {
    secret: string;
  }): Observable<StrictHttpResponse<LoginResponse>> {

    const rb = new RequestBuilder(this.rootUrl, InvitationControllerService.AcceptInvitationPath, 'put');
    if (params) {
      rb.path('secret', params.secret, {});
    }
  ...
  acceptInvitation(params: {
    ...
    return this.acceptInvitation$Response(params).pipe(
